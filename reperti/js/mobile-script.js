...
// ambiente1
	...
	$( "#detail-a1-1 .c2-close" ).click(function() {
		...
		$('body').scrollTo($( "#title-box-1" ),1000);
...
$( "#a1-d2" ).click(function() {
		...
		$('body').scrollTo($( "#detail-a1-2" ),1000);
...
$( "#a2-d1" ).click(function() {
	...
	$('body').scrollTo($( "#title-box-2" ),1000);
		});
...
$( "#a3-d1" ).click(function() {
	...
	$('body').scrollTo($( "#title-box-3" ),1000);
		});
...
$( "#a4-d1" ).click(function() {
	...
	$('body').scrollTo($( "#title-box-4" ),1000);
		});
